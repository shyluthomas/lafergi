...
<td class="contentArea"><!--Pages Content Area Start-->
   	...
   	<div class="contentArea_inn">
        	...
        	<div class="pageWise_TTL">
            	...
            	<div class="pageName"><img src="<?php echo $admin_image_path;?>bsns_icon3.png" alt=""> Manage Gallery</div>
                <div class="pageName" style="float:right;"> <a href="<?php  echo site_url(); ?>/backend/gallery/add">Add Gallery</a></div>
                <?php
                            ...
                            <?php foreach($arr_view as $req):?>
								...
								<tr class="<?php if(($div_count % 2)==0){echo "even"; }else{echo "odd";}?>">
    								...
    								<td><?php echo ucfirst(stripslashes($req['title']));?></td>
                                     ...
                                     <td><img src="<?php echo $imgPath.'gallery/thump/'.$req['image'];?>" height="50px"/></td>      												
                                ...
                                <a onclick="return confirm('Do ypu really want to delete this item?')" href="<?php echo site_url(); ?>/backend/gallery/delete/<?php echo stripslashes($req['id']); ?>/<?php echo $page; ?>">
