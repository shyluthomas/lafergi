...
<td class="contentArea"><!--Pages Content Area Start-->
   	...
   	<div class="contentArea_inn">
        	...
        	<div class="pageWise_TTL">
            	...
            	<div class="pageName"><img src="<?php echo $admin_image_path; ?>bsns_icon1.png" alt=""> Add Careers</div>
            ...
            <div class="frmFieldTTL"><span>ADD careers</span></div>
            ...
            <div class="frmFieldContent">
            	...
            	<div class="frmFieldContentInn">
                    ...
                    <div class="frmFieldItem">
                     ...
                     <input  value="" type="text" class="txtbx" placeholder="Enter  here." name="qualification" required="required">
                    </div>
