...
<td class="contentArea"><!--Pages Content Area Start-->
   	...
   	<div class="contentArea_inn">
        	...
        	<div class="pageWise_TTL">
            	...
            	<div class="pageName"><img src="<?php echo $admin_image_path; ?>bsns_icon1.png" alt=""> Add Destination</div>
            ...
            <div class="frmFieldTTL"><span>ADD Destination</span></div>
            	...
            	<div class="frmFieldContentInn">
                    ...
                    <div class="frmFieldItem">
                    	...
                    	<span>Temperature </span>
						 <input value="" type="text" class="txtbx" placeholder="Enter  here." name="temperature" required="required">
