...
<td class="contentArea"><!--Pages Content Area Start-->
   	...
   	<div class="contentArea_inn">
        	...
        	<div class="pageWise_TTL">
            	...
            	<div class="pageName"><img src="<?php echo $admin_image_path;?>bsns_icon3.png" alt=""> Manage Destination</div>
                <div class="pageName" style="float:right;"> <a href="<?php  echo site_url(); ?>/backend/about/add">Add New</a></div>
                <?php
                            ...
                            <?php foreach($arr_view as $req):?>
								...
								<tr class="<?php if(($div_count % 2)==0){echo "even"; }else{echo "odd";}?>">
    								...
    								<td><?php echo ucfirst(stripslashes($req['title']));?></td>
									 ...
									 <?php  echo site_url(); ?>/backend/about/edit/<?php echo stripslashes($req['id']);?>">
                                ...
                                <a onclick="return confirm('Do ypu really want to delete this item?')" href="<?php echo site_url(); ?>/backend/about/delete/<?php echo stripslashes($req['id']); ?>">
