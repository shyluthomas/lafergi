...
Gv = Object.merge(Gv, {
  env: 'dev',
  url: {
    ext: 'http://198.1.74.28/~spaniac1/imyrtle/'
  }
});
//]>
</script>
	...
	function request_submit()
	{
		...
		else
		{
			var form_data = {                           
			 ...
			 $.ajax({
                            url: "<?php echo base_url();?>index.php/user/request_property/",
                            type: "post",
                            data: form_data,
                            success: function(msg) {
									if(msg==1)
...
function validate_quote()
	...
	function share_submit()
	{
		...
		var error1='';
		if($('#share_name').val()==''){document.getElementById("val_share").innerHTML=' <div class="walid" >Name Required</div> ';error1=1;}
		if($('#share_email').val()==''){document.getElementById("val_share").innerHTML=' <div class="walid" >Email Required</div> ';error1=1;}
		...
		{
			var form_data = {                           
                            name: $('#share_name').val(),email: $('#share_email').val(),property: $('#share_prop').val()							                       
                        };	
			 $.ajax({
...
<!--Popup 2--->
<div id="popup_calculator" class="popup_outer_calc">
		<a id="popup2_close" class="popUp_close"></a>
        <div class="ppUpttl">

			<h1>Share Property</h1>
        </div>
		 <div id="val_share" ></div>
		<div class="ppUpContent">
...
return false;">
<img src="<?php echo $image_path; ?>fb_sha.png" />
</a></li>
...
<li><li>
	...
	<div class="ppItem">
        		<span class="ppupName">From:</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Fist Name" class="ppuptxtbx shar_wid" name="share_name" id="share_name">
<input type="text" placeholder="Last Name" class="ppuptxtbx shar_wid shar_mar" name="share_name" id="share_name">
            ...
            <div class="ppItem">
        		<span class="ppupName"></span>
                <div class="ppupAns">
                	<input type="text" placeholder="Email" class="ppuptxtbx" name="share_email" id="share_email">
                    <input type="hidden" name="property" value="<?php echo uri_string(); ?>"  id="share_prop"/>
                </div>
            </div>


 <div class="ppItem">
        		<span class="ppupName">To :</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Name" class="ppuptxtbx" name="share_email" id="share_email">
                    <input type="hidden" name="property" value="<?php echo uri_string(); ?>"  id="share_prop"/>
                </div>
            </div>
...
<div class="ppItem">
        		<span class="ppupName"></span>
                <div class="ppupAns">
                	<input type="text" placeholder="Suject" class="ppuptxtbx" name="share_email" id="share_email">
                    <input type="hidden" name="property" value="<?php echo uri_string(); ?>"  id="share_prop"/>
                </div>
            </div>
...
<div class="ppItem">
        		<span class="ppupName"></span>
                <div class="ppupAns">
                	<textarea placeholder="Enter your message" class="ppuptxtArea" name="req_date" id="msg"></textarea>
                </div>
            </div>
            ...
            <div class="ppItem">
                ...
                <div id="captcha_share" style="width:157px;float:left;padding-left:7px;padding-bottom:5px;"><img src="<?php echo base_url().'images/captcha/1377600760.1257.jpg';?>" /></div>
                <div><a href="#" onclick="return create_captcha_share()" ><img src="<?php echo $image_path; ?>lod.png" /></a></div>
                <div class="ppupAns" style="padding: 0px 2px 0px 0px;">
                        
                	<input type="text" placeholder="Enter Captcha here." class="ppuptxtbx" name="share_captcha" id="share_captcha">
            ...
            <div class="ppItem3">
            <div class="con">
        		<input type="button" name="submit" value="Submit" class="btnblue" onclick="return share_submit()" value="Share">
            </div>
            </div>
	...
	<div id="popup2_bg" class="popup_black"></div>
<!--End of Popup 2-->
...
<!--Popup 2--->
<div id="popup_direction" class="popup_outer_calc">
		<a id="popup4_close" class="popUp_close"></a>
        <div class="ppUpttl">
        ...
        <form name='first' method="post" enctype="multipart/form-data">
        	<div class="ppItem">
        		<span class="ppupName"> Price :</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Price" class="ppuptxtbx" id="aa" name="aa" onkeyup='checnum(this)' value="<?php echo $onlinepro[0]['L_OriginalPrice'];?>">
                </div>
            </div>


<div class="ppItem">
        		<span class="ppupName"> Down Payment :</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Down Payment" class="ppuptxtbx sel_wid" id="r1" name="r1" id="emi">
<label>%</label>
                </div>
            </div>

<div class="ppItem">
        		<span class="ppupName"> Loan Amount :</span>
<div class="ppupAns"> <div class="res_view">$14,040,000</div></div>
                
            </div>


<div class="ppItem">
        		<span class="ppupName">Loan Type :</span>
                <div class="ppupAns">

					
            <select class="pop_drop" id="bb"  name="bb">
            <option value="">30 Years Fixed</option>
            	<option value="5">20 Years Fixed</option>     
            	<option value="10">10 Years Fixed</option>                
                <option value="1">5 Years Fixed</option>
                <option value="2">3 Years Fixed</option>
                <option value="3">2 Years Fixed</option>
                <option value="4">1 Years Fixed</option> 
            </select>
...
<div class="ppItem">
        		<span class="ppupName"> Interest Rate :</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Interest Rate" class="ppuptxtbx sel_wid" id="r2" name="r2">
<label>%</label>
                </div>
            </div>
...
<div class="ppItem">
        		<span class="ppupName"> Est. Tax & Insurance :
</span>
                <div class="ppupAns">
                	<input type="text" placeholder="Est. Tax & Insurance" class="ppuptxtbx sel_wid" id="r3" name="r3">
<label>% ($7,904/mo.)</label>
                </div>
            </div>
...
<div class="ppres">
        		<span class="ppresName"> Est. Monthly Payment :
</span>
                <div class="ppresview">
                	$29 per month
                </div>
	...
	<div id="popup4_bg" class="popup_black"></div>
<!--End of Popup 2-->
