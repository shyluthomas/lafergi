					...
					<div class="container">
						<div class="row">
							<section class="col-sm-6">
								<h1 class="text-upper">Packages</h1>
							</section>
					...
					<div class="row">
						<div class="col-md-8">
                            ...
                            <?php foreach ($packages as $pack): ?>
                                ...
                                <img alt="<?php echo $pack['title'];?>" title="<?php echo $pack['title'];?>" style="height: 200px;" src="<?php echo $asset_path_backend.'images/packages/'.$pack['image'];?>" draggable="false"></a>
										</span>
										<div class="ft-data">
						...
						<?php if(@$pack['breakfast']){?>	<a href="#" class="ft-tea text-upper">Break Fast</a><?php }?>
										...
										<div class="ft-foot">
											<h4 class="ft-title text-upper"><a href="<?php echo site_url().'/packages/packagesMore/'.$pack['id']?>" title="<?php echo $pack['title'];?>"><?php echo substr($pack['title'],0,25);?></a></h4>
											<span class="ft-offer text-upper">Starting From <?php echo $pack['prize'];?> &euro;</span>
										</div>
						...
						<aside id="sidebar" class="col-md-4">
							<div class="sidebar-widget">
								...
								<img class="img-responsive" src="<?php echo $asset_path_backend.'images/destination/'.$dest['image'];?>" alt="Recent Post 2" />
												...
												<span class="rc-post-date small"><?php echo substr(stripslashes($dest['description']),0,40);?></span>
											</li>
									...
									<div class="tab-pane" id="recent-posts">
										<ul class="rc-posts-list list-unstyled">
                                          ...
                                          <?php foreach($hotels as $hot):?>
											<li>
												<span class="rc-post-image">
													<img class="img-responsive" src="<?php echo $asset_path_backend.'images/hoteldirectory/'.$hot['image'];?>" alt="<?php echo stripslashes($hot['title']);?>" />
												</span>
