						...
						<div class="col-md-8">
                            ...
                            <?php foreach ($destination as $dest): ?>
								<div class="col-md-6">
									<div class="ft-item">
										<span class="ft-image">
								<a href="<?php echo site_url().'/destination/destinationMore/'.$dest['id']?>"><img alt="" src="<?php echo $asset_path_backend.'images/destination/'.$dest['image'];?>" draggable="false" height="185" width="370"></a>
										</span>
										<div class="ft-data">
											
										</div>
										<div class="ft-foot">
											<h4 class="ft-title text-upper"><a href="<?php echo site_url().'/destination/destinationMore/'.$dest['id']?>"><?php echo $dest['title'];?></a></h4>
											<?php /*?><span class="ft-offer text-upper">Starting From <?php echo $dest['title'];?> $</span><?php */?>
										</div>
										<div class="ft-foot-ex">
											<span class="ft-date text-upper alignleft"><?php echo $dest['createtime'];?></span>
											<span class="ft-temp alignright"><?php echo $dest['temperature'];?></span>
										</div>
									</div>
								</div>
								<?php  endforeach;?>
						...
						<aside id="sidebar" class="col-md-4">
							<div class="sidebar-widget">
								...
								<ul class="nav nav-tabs text-upper">
									<li class="active"><a href="#popular-posts" data-toggle="tab">Packages</a></li>
								...
								<img class="img-responsive" src="<?php echo $asset_path_backend.'images/packages/'.$pack['image'];?>" alt="Recent Post 2" />
												</span>
												<h5><a href="#"><?php echo substr($pack['title'],0,50);?>.</a></h5>
												<span class="rc-post-date small"><?php echo $pack['createtime'];?></span>
											</li>
