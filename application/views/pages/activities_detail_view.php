...
<section class="page">
	...
	<div class="container">
        ...
        <div class="post">
			...
			<p>
			<a href="<?php echo base_url().'images/activities/'.$abt_details['image'];?>" class="html5lightbox post-image" 
            style="width:auto;height:auto;">

						<img src="<?php echo base_url().'images/activities/'.$abt_details['image'];?>" alt="" />

					</a>
			<?php echo $abt_details['content'];?></p>
