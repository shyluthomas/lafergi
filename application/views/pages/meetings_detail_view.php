...
<section class="page">
	...
	<div class="container">
        ...
        <div class="post">
			...
			<p><?php echo $abt_details['content'];?></p>

				<div class="post-image-list">

					<a href="<?php echo base_url().'images/meetings/'.$abt_details['image'];?>" class="html5lightbox post-image" style="width:auto;height:auto;">

						<img src="<?php echo base_url().'images/meetings/'.$abt_details['image'];?>" alt="" />
