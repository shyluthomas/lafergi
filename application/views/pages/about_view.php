...
<section class="page">
	...
	<div class="container">
		...
		<div class="page-title">
			...
			<h1> <span><?php echo $abt_details['about_title'];?></span></h1>
        ...
        <div class="post">
			...
			<a href="<?php echo base_url().'images/aboutus/'.$abt_details['image'];?>" class="html5lightbox post-image" >
						<img src="<?php echo base_url().'images/aboutus/'.$abt_details['image'];?>" alt="" />
					</a>
			<?php echo $abt_details['about_content'];?>
