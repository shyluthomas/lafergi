<?php
class Visiter_model extends MY_Model
{
	public $_table 		= 'tbl_visiter';
	public $primary_key = 'visiter_id';
	...
	function search_like($search)
	{
		if($search != '' && $search != 'Search') {
			$this->db ->or_like('visiter_name',$search);
			$this->db ->or_like('visiter_email',$search);
			$this->db ->or_like('visiter_phone',$search);
		}
		return $this;
	}
